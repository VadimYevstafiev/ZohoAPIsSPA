...
class ZohoService implements APIserviceContract
{
    ...
    protected function getGrantToken(string $url, string $scope): Response
    {
    ...
    protected function getAccessToken(string $url, string $code): Response
    {
    ...
    protected function refreshToken(string $url, string $refreshToken): Response
    {
        return Http::withUrlParameters([
            'url' => $url,
            'version' => config('zohoapis.version'),
